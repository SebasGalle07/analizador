...
- `src/extraccion_datos.py` ejecuta el ETL desde Yahoo Finance.
- `src/analisis_financiero.py` contiene los algoritmos de similitud, riesgo, patrones y correlacion.
- `src/visualizacion.py` genera graficas PNG.
- `src/reporte_pdf.py` arma un PDF tecnico.
